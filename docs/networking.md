...
heard hosts (4 s TTL) into a connect list, with **manual IP** as the reliable fallback (many real networks —
phone hotspots, AP/client isolation — drop broadcast). The beacon's game magic lets clients ignore foreign
